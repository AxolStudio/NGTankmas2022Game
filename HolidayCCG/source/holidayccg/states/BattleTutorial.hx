...
class BattleTutorial extends FlxSubState
{
	...
	public function new(Callback:Void->Void):Void
	{
		...
		add(tutorial3 = new TutorialMessage("^ Your Deck is here", 96, 120));
		add(tutorial4 = new TutorialMessage("Your opponent's Deck is here [", 0, 360));
		tutorial4.x = 768 - 10 - tutorial4.width;
